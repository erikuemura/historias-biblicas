...
export default function ShareButtons({ title, slug }: ShareButtonsProps) {
  ...
  function copyToClipboard(type: "link" | "instagram") {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <a
        ...
        className="w-9 h-9 rounded-xl flex items-center justify-center text-white transition-opacity shadow-sm hover:opacity-85"
      ...
      <div className="relative">
        ...
        {copied === "instagram" && (
          <div className="absolute bottom-11 left-1/2 -translate-x-1/2 whitespace-nowrap bg-gray-900 text-white text-xs font-medium px-3 py-1.5 rounded-lg shadow-lg">
